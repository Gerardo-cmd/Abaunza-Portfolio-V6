  ...
  <Layout title="Recipe Application">
    <Container>
      ...
      <List ml={4} my={4}>
        ...
        <ListItem>
          <Meta>Stack</Meta>
          <span>Javascript, HTML, CSS, Bootstrap, Node.js, Express, PostgreSQL, Netlify (Frontend), Heroku (Backend)</span>
        </ListItem>
      </List>

      <WorkImage src="/images/projects/recipe-1.png" alt="Recipe App" />
      <WorkImage src="/images/projects/recipe-2.png" alt="Recipe App" />
    </Container>
  </Layout>
)
